...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Simulation.public_status'
        db.delete_column('specification_simulation', 'public_status')


    def backwards(self, orm):
        
        # Adding field 'Simulation.public_status'
        db.add_column('specification_simulation', 'public_status', self.gf('django.db.models.fields.CharField')(default='P', max_length=2), keep_default=False)
