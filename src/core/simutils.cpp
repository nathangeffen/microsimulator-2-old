...
double microsimulator::normalize_identity(double proportion,
                                          double fromTimePeriod,
                                          double toTimePeriod)
{
  return proportion;
...
// Common output aggregate calculations
...
SimulationException::SimulationException(QString message, int line, string file)
{
    message_ = message;
    line_ = line;
    file_ = file;
