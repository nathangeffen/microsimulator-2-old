...
typedef map<QString, StateParameter> ParameterMap;
typedef int StateIndex; // Not yet in use
typedef vector<State*> StateVector;
typedef map<QString, double> StateValueMap;
...
typedef tuple <QString, int, AnalysisFunction, FilterFunctionList>
              AnalysisDescriptor;
...
public:
  SimulationException(QString message, int line=0, string file="");
